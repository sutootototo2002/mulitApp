...
var Bindcard = (_temp2 = _class = function (_BaseComponent) {
  ...
  return Bindcard;
}(_index.Component), _class.$$events = ["detail", "unbind", "addbind", "onscan", "done", "onbindCardFn"], _temp2);
exports.default = Bindcard;

Page(require('../../npm/_tarojs/taro-alipay/index.js').default.createComponent(Bindcard, true));