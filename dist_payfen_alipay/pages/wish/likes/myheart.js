...
var Myheart = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Myheart, [{
    ...
    value: function _constructor(props) {
      ...
      this.state = {
        ...
        avator: _index3.globalData.avatar ? _index3.globalData.avatar : _index3.PATH + 'tempavator.png',
        imgs: _index3.PATH + 'xytb.png',
        imgs1: _index3.PATH + 'xytb-1.png',
        zmkm: _index3.PATH + 'zmkm0.png',
        clear: _index3.PATH + 'ljx1.png',
        value: '',
        bool: false,
        HearBoolean: false,
  ...
  return Myheart;
}(_index.Component), _class.$$events = ["ondelFn", "addWishFn", "unlikeit", "likeit", "oncheckdetail", "toBoxdetail", "onModify", "addgoods", "fetchMoreLikes", "onSearchHandler", "onInput", "onGoback", "onCloseHeard"], _temp2);
