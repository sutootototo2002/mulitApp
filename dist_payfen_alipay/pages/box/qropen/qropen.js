...
var Qropen = (_temp2 = _class = function (_BaseComponent) {
  ...
  return Qropen;
}(_index.Component), _class.$$events = ["getPhoneNumber", "gotopayfen", "submitInfo", "payOrder", "onconcel"], _temp2);
exports.default = Qropen;

Page(require('../../../npm/_tarojs/taro-alipay/index.js').default.createComponent(Qropen, true));