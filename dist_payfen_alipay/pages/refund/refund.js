...
var Refund = (_temp2 = _class = function (_BaseComponent) {
  ...
  return Refund;
}(_index.Component), _class.$$events = ["selectNav", "del", "handleChange", "chooseImage", "submitRefund"], _temp2);
exports.default = Refund;

Page(require('../../npm/_tarojs/taro-alipay/index.js').default.createComponent(Refund, true));