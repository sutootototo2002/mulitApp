...
var Login = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loginImg"], _this.config = {
  ...
  return Login;
}(_index.Component), _class.$$events = [], _temp2);
