...
var Recharge = (_temp2 = _class = function (_BaseComponent) {
  ...
  return Recharge;
}(_index.Component), _class.$$events = ["onselectNav", "onClose", "onAnswer", "ongenerateorder", "onCloseSuccess", "onMM"], _temp2);
exports.default = Recharge;

Page(require('../../npm/_tarojs/taro-alipay/index.js').default.createComponent(Recharge, true));