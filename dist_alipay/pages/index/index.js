...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "unpayList", "systemUser", "mapKey", "latitude", "longitude", "scale", "menus", "screen", "user", "person", "zm", "searchImg", "dw", "unpayImg", "unpriceImg", "tempImg", "del", "controls", "isOpened", "mapObj", "showLocation", "markers", "allMarkers", "bool", "menuright", "token", "checkPapay", "commonCode", "markBoolean", "posBoolean", "unpayBoolean", "machineBoolean", "payName"], _this.config = {
  ...
  return Index;
}(_index.Component), _class.$$events = ["onControlTap", "onInfo", "onClosePos", "onPay", "onScreen", "onRight", "onLeft"], _temp2);
// #region 导出注意
//
